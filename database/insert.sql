...
INSERT INTO METODO_PAGO (DEFAULT) VALUES;
INSERT INTO METODO_PAGO (DEFAULT) VALUES;
INSERT INTO METODO_PAGO (DEFAULT) VALUES;
INSERT INTO METODO_PAGO (DEFAULT) VALUES;
INSERT INTO METODO_PAGO (DEFAULT) VALUES;
...
CREATE OR REPLACE PROCEDURE pipu (INT, INT, FLOAT)
AS
$$
DECLARE
  cliente_id INT;
...
BEGIN
  ...
  IF $2 = 3 THEN
    SELECT fk_cliente INTO cliente_id
    FROM VENTA
    WHERE eid = $1;
...
CREATE OR REPLACE FUNCTION trigger_esta_vent_set_pagada()
  RETURNS TRIGGER
  AS $$
BEGIN
  INSERT INTO ESTA_VENT(fk_estatus, fk_venta, fecha_inicio)
    VALUES(3, NEW.eid, CURRENT_DATE);
  RETURN NEW;
END
$$
LANGUAGE plpgsql;

CREATE OR REPLACE TRIGGER trigger_esta_vent_set_pagada
  AFTER INSERT ON Venta
  FOR EACH ROW
  EXECUTE FUNCTION trigger_esta_vent_set_pagada();
...
CREATE OR REPLACE TRIGGER trigger_sumar_puntos_al_pagar_venta
